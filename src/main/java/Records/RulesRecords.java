...
public class RulesRecords {
    ...
    public RulesRecords(int id, int company_id, String start_date, String end_date, String gift_date, int gift_price) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        RulesRecords that = (RulesRecords) o;
        return id == that.id &&
