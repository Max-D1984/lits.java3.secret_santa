...
public class UserInCompanyInformationResponse {
    String name;
    String targetUser;
    String statusChoose;
    String statusBuy;
    ...
    public UserInCompanyInformationResponse() {
    }
    ...
    public boolean equals(Object o) {
        ...
        UserInCompanyInformationResponse that = (UserInCompanyInformationResponse) o;
